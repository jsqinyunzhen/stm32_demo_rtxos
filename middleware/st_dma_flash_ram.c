...
int main_dma_rom2ram(void)
{
  /*!< At this stage the microcontroller clock setting is already configured, 
	...
	printf("main_dma_rom2ram\r\n");
	dma_copy_data_start(SRC_Const_Buffer,DST_Buffer,BufferSize*4);
	return 0;
 ...
 printf("CurrDataCounterBegin=%d\r\n",CurrDataCounterBegin);
  ...
  CurrDataCounterBegin = DMA_GetCurrDataCounter(DMA1_Channel6);
 printf("CurrDataCounterBegin 2=%d\r\n",CurrDataCounterBegin);
  ...
  time_end = get_curtime();
  printf("dma pcm data time_e=%d s=%d end=%d\r\n",time_end,time_start,CurrDataCounterEnd);
