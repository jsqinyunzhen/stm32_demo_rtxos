...
#define sFLASH_CMD_WRDIS           0x06  /*!< Write disable instruction ---*/

#define sFLASH_CMD_READ           0x03  /*!< Read from Memory instruction */
#define sFLASH_CMD_FAST_READ           0x0B  /*!< Read from Memory instruction ---*/
#define sFLASH_CMD_RDSR           0x05  /*!< Read Status Register instruction  */
#define sFLASH_CMD_RDID           0x9F  /*!< Read identification */

#define sFLASH_CMD_SE_4k             0x20  /*!< Sector Erase instruction--- */ //32k
#define sFLASH_CMD_SE_32k            0x52  /*!< Sector Erase instruction ---*/ //32k
#define sFLASH_CMD_SE             0xD8  /*!< Sector Erase instruction */ //64k
#define sFLASH_CMD_BE             0xC7  /*!< Bulk Erase instruction */ //chip erase

#define sFLASH_WIP_FLAG           0x01  /*!< Write In Progress (WIP) flag */

//#define sFLASH_DUMMY_BYTE         0xA5 //MXIC
#define sFLASH_DUMMY_BYTE         0x0 //---SST
#define sFLASH_SPI_PAGESIZE       0x100
#define sFLASH_SPI_SECTORSIZE       0x10000

#define sFLASH_M25P128_ID         0x202018
#define sFLASH_M25P64_ID          0x202017
#define sFLASH_SST25VF016B_ID     0x00bf2541
#define sFLASH_GD25Q64C_ID       0x00c84017

#define  sFLASH_WB25Q64JV_ID     0x00ef4017
...
unsigned char sFLASH_ReadStatus(void);
#ifdef __cplusplus
}
#endif
